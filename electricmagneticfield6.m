function [electron_position,electron_velocity,ion1_position,ion1_velocity,ion2_position,ion2_velocity,Er,Ez,Hphi,electron_kinetic] = electricmagneticfield6(electron_position0,electron_velocity,ion1_position0,ion1_velocity,ion2_position0,ion2_velocity,Er,Ez,Hphi,delta,dt,Rp,Lp,PHIp,FN,cycle_time_for_electromagneticfield)
...
for k=1:(cycle_time_for_electromagneticfield/ratio)
    ...
    [~,~,~,~,~,gridjr,gridjz,~] = feval(kernel6, r, z, particle_charge, vr, vz, jr, jz, parDelete, particle_number, 100, 500, delta_r, delta_z, FN, PHIp);
